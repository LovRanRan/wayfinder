...
def test_behavioral_intents_fan_out_cartographer_then_investigator() -> None:
    # Symbol/behaviour questions run architecture-first so the symbol path has
    # architect_mapper entry points as a fallback candidate (design note 021).
