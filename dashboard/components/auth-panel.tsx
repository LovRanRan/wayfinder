    ...
    <section className="grid min-h-[560px] overflow-hidden rounded-lg border border-border bg-card lg:grid-cols-[0.9fr_1.1fr]">
      <div className="border-b border-border bg-muted/50 p-6 lg:border-b-0 lg:border-r">
        <div className="flex h-full flex-col justify-between gap-8">
          <div>
            ...
            <h1 className="mt-5 text-2xl font-semibold">wayfinder workspace</h1>
      ...
      <form className="grid content-center gap-4 p-6" onSubmit={submit}>
        ...
        <label className="grid gap-1.5 text-xs uppercase text-muted-foreground">
          workspace id
          <input
            className="h-11 rounded-md border border-border bg-background px-3 text-sm normal-case text-foreground outline-none transition placeholder:text-muted-foreground focus:border-primary"
            value={workspaceId}
